...
class BaseRepository:
    ...
    def execSql(self, arquivo_sql: str, *param: tuple, commit: bool = False) -> int:
        """Executa um arquivo SQL não SELECT com os parâmetros fornecidos e retorna o id de alteração."""
        res: dict = self.db.executar(arquivo_sql=arquivo_sql, parametros=(*param,), autocommit=commit)
        return res[0]
